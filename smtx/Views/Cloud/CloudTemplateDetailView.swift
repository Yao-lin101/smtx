        ...
        ScrollView {
            if let template = viewModel.templates.first {
                VStack(spacing: 16) {
                    ...
                    TimelinePreviewView(
                        timelineItems: [
                            TimelineItemData(script: "示例文本1", imageData: nil, timestamp: 1.0),
                            TimelineItemData(script: "示例文本2", imageData: nil, timestamp: 2.5),
                            TimelineItemData(script: "示例文本3", imageData: nil, timestamp: 4.0)
                        ],
